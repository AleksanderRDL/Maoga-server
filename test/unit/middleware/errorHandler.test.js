...
const { AppError, ValidationError, AuthenticationError, NotFoundError } = require('../../../src/utils/errors');
...
describe('GlobalErrorHandler Middleware', () => {
    ...
    it('should handle Mongoose DuplicateFieldsDB error (11000) as operational in production', () => {
        ...
        expect(mockRes.json.calledWithMatch({ // Use calledWithMatch if details might be null or an object
            status: 'error',
            error: {
