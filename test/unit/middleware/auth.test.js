...
describe('Auth Middleware - authorize', () => {
    ...
    it('should throw AuthorizationError if user role is not in allowedRoles', () => {
        ...
        expect(() => authMiddleware(mockReq, mockRes, nextSpy)).to.throw(AuthorizationError, 'Insufficient permissions');
    ...
    it('should throw AuthenticationError if req.user is not defined', () => {
        ...
        expect(() => authMiddleware(mockReq, mockRes, nextSpy)).to.throw(AuthenticationError, 'User not authenticated');
